...
python run_classifier.py \
  ...
  python run_classifier.py --task_name=BND --max_seq_length=64 --do_predict=true --data_dir=$BNEWS_DATA --predict_data=$DATA_PRED --vocab_file=$BERT_BASE_DIR/vocab.txt --bert_config_file=$BERT_BASE_DIR/bert_config.json --init_checkpoint=$BERT_BASE_DIR/bert_model.ckpt --output_dir=/home/matheusgomes/bert/outsplit1 > ../out_bert.txt